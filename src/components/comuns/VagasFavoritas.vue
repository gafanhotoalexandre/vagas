<template>
  <div>
    <div class="div-vagas-favoritas">
      <button class="btn btn-dark" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">Vagas Favoritas</button>
    </div>
      ...
      <div class="offcanvas-body">
        <ul class="list-group">
          <li class="list-group-item"
            v-for="(vaga, indice) in vagas" :key="indice">{{ vaga }}</li>
        </ul>
      </div>
    </div>
  </div>
